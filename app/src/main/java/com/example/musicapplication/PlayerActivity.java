...
public class PlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnnext = findViewById(R.id.playnext);
        btnprev = findViewById(R.id.playprevious);
        btnforward = findViewById(R.id.fast_forwardbtn);
        btnrewind = findViewById(R.id.fast_rewindbtn);
